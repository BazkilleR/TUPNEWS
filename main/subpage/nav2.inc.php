<nav class="navbar navbar-expand-lg sticky-top" id="navbar_top" style="background-color: #182A54;">
    <div class="container-fluid navf">
        ...
        <div class="offcanvas-lg offcanvas-end" tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
            <div class="offcanvas-header" style="background-color: #182A54; color: whitesmoke;">
                <h5 class="offcanvas-title" id="offcanvasResponsiveLabel">Tup41</h5>
                <button type="button" class="btn-close" data-bs-dismiss="offcanvas" data-bs-target="#offcanvasResponsive" aria-label="Close" style="background-color: whitesmoke; box-shadow: none;"></button>
            </div>
