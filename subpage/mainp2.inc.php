            ...
            <article class="card article-card">
              <a href="article.html">
                <div class="card-image">
                  <div class="post-info"> <span class="text-uppercase"><?php echo $UploadDate ?></span></div>
                  <img loading="lazy" decoding="async" src="<?php echo $img; ?>" alt="Post Thumbnail" class="w-100">
                </div>
              </a>
              <!-- body -->
              <div class="card-body px-0 pb-1">
                ...
                <h2 class="h1"><?php echo "<a href='show_detail.php?id=" . $id . "'>" . $topic . "</a>" ?></h2>
                <p class="card-text">Hmmmmmmmmm</p>
                <div class="content"> 
            ...
            <article class="card article-card article-card-sm h-100">
              <a href="article.html">
                <div class="card-image">
                  ...
                  <img loading="lazy" decoding="async" src="img/news2.jpg" alt="Post Thumbnail" class="w-100">
                </div>
              </a>
              <div class="card-body px-0 pb-0">
                ...
                <h2>
                  <a class="post-title" href="article.html">An
                      Experiential Guide to Explore This Kingdom</a>
                </h2>
            ...
            <article class="card article-card article-card-sm h-100">
              <a href="article.html">
                <div class="card-image">
                  ...
                  <img loading="lazy" decoding="async" src="img/news3.jpg" alt="Post Thumbnail" class="w-100">
                </div>
              </a>
              <div class="card-body px-0 pb-0">
                <ul class="post-meta mb-2">
            ...
            <article class="card article-card article-card-sm h-100">
              <a href="article.html">
                <div class="card-image">
                  ...
                  <img loading="lazy" decoding="async" src="img/news4.jpg" alt="Post Thumbnail" class="w-100">
                </div>
              </a>
              <div class="card-body px-0 pb-0">
                <ul class="post-meta mb-2">
            ...
            <article class="card article-card article-card-sm h-100">
              <a href="article.html">
                <div class="card-image">
                  ...
                  <img loading="lazy" decoding="async" src="img/news5.jpg" alt="Post Thumbnail" class="w-100">
                </div>
              </a>
              <div class="card-body px-0 pb-0">
                <ul class="post-meta mb-2">
            ...
            <article class="card article-card article-card-sm h-100">
              <a href="article.html">
                <div class="card-image">
                  ...
                  <img loading="lazy" decoding="async" src="img/news6.jpg" alt="Post Thumbnail" class="w-100">
                </div>
              </a>
              <div class="card-body px-0 pb-0">
                <ul class="post-meta mb-2">
            ...
            <article class="card article-card article-card-sm h-100">
              <a href="article.html">
                <div class="card-image">
                  ...
                  <img loading="lazy" decoding="async" src="img/news7.jpg" alt="Post Thumbnail" class="w-100">
                </div>
              </a>
              <div class="card-body px-0 pb-0">
                <ul class="post-meta mb-2">
      ...
      <div class="col-lg-12 col-md-6">
        <div class="widget">
          <div class="d-grid gap-2 widget-head ">
            <a href="http://43.229.77.153/~ztrad/tup_conn34/" class="btn wbtn rounded-0 btn-lg " role="button" type="button">รายงานผลการเรียน</a>
            <a href="" class="btn wbtn rounded-0 btn-lg wbtn" role="button" type="button">ทำเนียบคณะกรรมการ ม.6</a>
          </div>
          <div>
            <h1>ข่าวสารสำคัญ</h1>
          </div>
          <div class="widget-body">
            <div class="widget-list">
              ...
              <a class="media align-items-center" href="article.html">
                <img loading="lazy" decoding="async" src="img/news.jpg" alt="Post Thumbnail" class="w-100">
